...
import ShriNath from "./img/ShriNath.jpeg";

function Team() {
  const team = [
    {
      name: "Sri Nath Dwivedi",
      pos: "Faculty Head",
      linkedin: "",
      img: ShriNath,
    },
    ...
    return (
      <div className="team-card" key={index}>
        ...
        <ul className="team-social">
          <li>
            <a rel="noreferrer" href={teamember.linkedin} target="_blank">
  ...
  return (
    <div className="team">
      <h1>Meet My Team</h1>
      <section className="team-grid">{teamcards}</section>
    </div>
  );
}
